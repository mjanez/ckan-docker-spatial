...
Run the following:
canary validate --file ckan.yaml mjanez/ckan-base-spatial:ckan-2.9.11

Make sure a CKAN container using the same port as mjanez/ckan-base-spatial:ckan-2.9.11 is not running before starting the validation